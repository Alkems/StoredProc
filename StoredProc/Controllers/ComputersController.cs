...
namespace StoredProc.Controllers
{
    public class ComputersController : Controller
    {
        ...
        public ComputersController(StoredProcDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,GPU,CPU,Price")] Computer computer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,GPU,CPU,Price")] Computer computer)
        {
            if (id != computer.Id)
            {
                return NotFound();
